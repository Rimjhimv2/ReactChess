...
// // Routes
// app.use("/user", userRoutes);
// app.use("/api/profile", restrictToLoginUserOnly, profileRoutes);
...
//     player1.on('disconnect', () => player2.emit('opponentDisconnected'));
//     player2.on('disconnect', () => player1.emit('opponentDisconnected'));
